...
1. As a patient i want to be able to book and cancel appointments easily
2. As a user, I want to be able to add entries to cancel a period on the clock to make it available to handle emergencies .
